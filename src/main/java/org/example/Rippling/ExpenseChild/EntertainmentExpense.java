...
public class EntertainmentExpense extends Expense  {
    ...
    public EntertainmentExpense(int expense_id, String trip_id, String vendorName, int amount) {
        super(expense_id, trip_id, ExpenseType.ENTERTAINMENT , vendorName, amount);
    }
