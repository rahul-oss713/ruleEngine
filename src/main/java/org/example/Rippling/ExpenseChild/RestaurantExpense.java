...
public class RestaurantExpense extends Expense  {

    public static List<ExpenseRule> ruleList;


    public RestaurantExpense(int expense_id, String trip_id, String vendorName, int amount) {
        super(expense_id, trip_id, ExpenseType.RESTAURANT, vendorName, amount);
    }
