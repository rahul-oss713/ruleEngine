...
public class SuppliesExpense extends Expense {

    public static List<ExpenseRule> ruleList;

    public SuppliesExpense(int expense_id, String trip_id, String vendorName, int amount) {
        super(expense_id, trip_id, ExpenseType.SUPPLIES , vendorName, amount);
    }
